...
![Horse populations for all provinces in Canada from 1906 - 1972](../results/horse_pops_plot.png){width=70% height=70% #fig-population}

We can see from @fig-population that Ontario, Saskatchewan and Alberta 
...
![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){width=70% height=70% #fig-st}

In @fig-st we zoom in and look at the province of `r largest_sd`, which had the largest spread of values in terms of standard deviation.
